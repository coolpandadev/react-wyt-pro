...
function ExpiredTrade() {
    ...
    return <div>
        <div className='w-screen h-screen flex flex-col justify-center items-center gap-3 px-5 sm:px-[5em] '>
            ...
            <h1 className='font-body font-bold text-[3em] md:text-[4em]'>Oh no!</h1>
            <p className='font-body text-[1.5em] sm:text-center md:text-[1.8em]'>We are sorry for the inconvenience! It looks like you are trying to access a trade that has been deleted or an error on our database</p>
